#ifndef AGRemapCore_BarbaraFixer_H
#define AGRemapCore_BarbaraFixer_H
...
namespace AGRemapCore {
     ...
     * @brief
     @rst
     Barbara's own ``.ini`` fixers, one per game version she needed a new one at
     :raw-html:`<br />` :raw-html:`<br />`

     Pair this with :cpp:class:`BarbaraParser`: the mod objects this fixer remaps are the ones
    ...
    class BarbaraFixer {
        public:
             ...
             * @brief
             ...
             @endrst
             */
            static IniFixBuilder::Factory v6_1ToBarbaraSummertime();
    };
}
