...
#include "AGRemapCore/data/IniFixData/Mona/MonaFixer.h"
...
namespace AGRemapCore {
    ...
    IniFixBuilder::Factory IniFixBuilderFuncs::mona4_0() {
    ...
    IniFixBuilder::Factory MonaFixer::v4_0() {
        return IniFixBuilderFuncs::mona4_0();
    }
