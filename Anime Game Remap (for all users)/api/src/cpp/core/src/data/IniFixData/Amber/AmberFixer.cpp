...
namespace AGRemapCore {
    ...
    IniFixBuilder::Factory IniFixBuilderFuncs::amber4_0() {
    ...
    IniFixBuilder::Factory IniFixBuilderFuncs::amber5_7() {
        // THE 5.7 FIX, which is amber4_0 plus ONE thing: the draw call moves.
    ...
    IniFixBuilder::Factory AmberFixer::v4_0() {
        return IniFixBuilderFuncs::amber4_0();
    }
